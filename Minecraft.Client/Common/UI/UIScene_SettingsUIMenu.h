...
private:
	...
	UIControl_CheckBox m_checkboxDisplayHUD, m_checkboxDisplayHand, m_checkboxDisplayDeathMessages, m_checkboxDisplayAnimatedCharacter, m_checkboxDeveloperSettings, m_checkboxSplitscreen, m_checkboxShowSplitscreenGamertags; // Checkboxes
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT( m_checkboxDeveloperSettings, "DeveloperSettings")
